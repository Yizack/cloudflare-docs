...
description: Explore how Cloudflare WARP client routes DNS and IP traffic through Zero Trust policies, enhancing security across Windows, macOS, Linux, iOS, and Android.
sidebar:
  order: 5
---
