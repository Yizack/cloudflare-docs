...
description: Learn how to configure DNS resolver IPs and hostnames in Cloudflare Zero Trust. Assign IPv4/IPv6 addresses and DoT/DoH hostnames for secure DNS queries.
sidebar:
  order: 2
---
